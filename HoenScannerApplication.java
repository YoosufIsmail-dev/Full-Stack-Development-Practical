...
public class HoenScannerApplication extends Application<HoenScannerConfiguration> {
    ...
    @Override
    public void initialize(final io.dropwizard.core.setup.Bootstrap<HoenScannerConfiguration> bootstrap) {
        // Existing initialization from the scaffold, if any, should remain here.
    }
